...
namespace WebApi.Extensions
{
    public static class ServicesExtensions
    {
        ...
        public static void ConfigureVersioninig(this IServiceCollection services)
        {
        ...
        public static void ConfigureSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(s =>
            {
                s.SwaggerDoc("v1", new OpenApiInfo
                {
                    Title = "bsStoreApp",
                    Version = "v1",
                    Description = "bsStoreApp Web API",
                    //TermsOfService = new Uri("https://www.bsstoreapp.com"),
                    Contact = new OpenApiContact
                    {
                        Name = "Ömer Bilgen",
                        Email = "omerbilgen01@gmail.com",
                        //Url = new Uri("https://www.omerbilgen.com")
                    }
                });
                ...
                s.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
                {
                    ...
                    Description = "Place to add JWT with Bearer: (Bearer JWT)",
                    Name = "Authorization",
